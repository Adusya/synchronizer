...
public class SynchronizerProperties {

	public SynchronizerProperties() throws SynchronizerPropertiesException {
		initFromProperties();
	}
	
	private final Logger logger = Logger.getLogger(SynchronizerProperties.class.getName());
